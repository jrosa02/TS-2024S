...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . g2tyavdgbs ) , 0 , 0 , 27 } ,
{ ( char_T * ) ( & rtDW . jbp4qtz0nd . LoggedData ) , 11 , 0 , 10 } } ;
static DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . A [
0 ] ) , 0 , 0 , 27 } } ; static DataTypeTransitionTable rtPTransTable = { 1U
, rtPTransitions } ;
